...
class Config:
	...
	@inject_arguments
	def __init__(self, graphic_output = True, event_dispatcher = None, time = 401, debug = False, allow_control = False):
		self.show_game_frame = False # graphic_output # Jeu en accéléré, sans superflu # TODO: à mettre en argument indépendant
