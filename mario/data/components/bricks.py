...
class Brick(pg.sprite.Sprite):
    ...
    def __init__(self, get_fps, x, y, contents=None, powerup_group=None, name='brick'):
    ...
    def start_bump(self, score_group):
        ...
        if self.contents == '6coins':
            ...
            if self.coin_total > 0:
                self.group.add(coin.Coin(self.get_fps, self.rect.centerx, self.rect.y, score_group))
                self.coin_total -= 1
                if self.coin_total == 0:
                    self.frame_index = 1
                    self.image = self.frames[self.frame_index]
    ...
    def opened(self):
        ...
        if self.contents == 'star' and self.powerup_in_box:
            self.group.add(powerups.Star(self.get_fps, self.rect.centerx, self.rest_height))
